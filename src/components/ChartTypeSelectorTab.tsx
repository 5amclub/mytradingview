...
import { Tabs, Tab, Box, FormControl, InputLabel, MenuItem, Paper, Select, Button, Checkbox, ListItemText, OutlinedInput, SelectChangeEvent, useMediaQuery, useTheme } from "@mui/material";
